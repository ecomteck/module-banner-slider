...
namespace Ecomteck\Bannerslider\Model\ResourceModel\Banner;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init('Ecomteck\Bannerslider\Model\Banner', 'Ecomteck\Bannerslider\Model\ResourceModel\Banner');
    }
    ...
    public function joinSliderTitle()
    {
        $this->getSelect()->joinLeft(
            ['sliderTable' => $this->getTable('ecomteck_bannerslider_slider')],
    ...
    public function addFieldToFilter($field, $condition = null)
    {
        ...
        if (in_array($field, $attributes) && $storeViewId) {
            if (!in_array($field, $this->_addedTable)) {
                ...
                $this->getSelect()
                    ->joinLeft(array($field => $this->getTable('ecomteck_bannerslider_value')), $sql, array());
