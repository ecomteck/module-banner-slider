...
namespace Ecomteck\Bannerslider\Block\Adminhtml\Slider\Edit\Tab;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
     ...
     * @param \Ecomteck\Bannerslider\Helper\Data                                    $bannersliderHelper [description]
    ...
    protected function _prepareForm()
    {
        ...
        $fieldMaps['sort_type'] = $fieldset->addField(
            ...
            [
                ...
                'values' => [
                    [
                        'value' => \Ecomteck\Bannerslider\Model\Slider::SORT_TYPE_RANDOM,
                        'label' => __('Random'),
                    ],
                    [
                        'value' => \Ecomteck\Bannerslider\Model\Slider::SORT_TYPE_ORDERLY,
                        'label' => __('Orderly'),
                    ],
                ],
            ]
        ...
        $positionImage = [];
        for ($i = 1; $i <= 5; ++$i) {
            $positionImage[] = $this->getViewFileUrl("Ecomteck_Bannerslider::images/position/bannerslider-ex{$i}.png");
        }
