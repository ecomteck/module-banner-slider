 ...
 */
class ExportExcel extends \Ecomteck\Bannerslider\Controller\Adminhtml\Slider
{
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('Ecomteck\Bannerslider\Block\Adminhtml\Slider\Grid')->getExcel();
